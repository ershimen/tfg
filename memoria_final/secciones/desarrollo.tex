...
Al principio se crea un \textit{socket} de red de tipo \texttt{SOCK\_RAW}, que recibe mensajes a nivel de protocolo ethernet. Seguidamente se comienza un bucle infinito que ejecuta lo siguiente:
